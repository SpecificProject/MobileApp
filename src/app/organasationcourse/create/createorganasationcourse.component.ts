...
@Component({
  selector: 'app-createorganasationcourse',
  templateUrl: './createorganasationcourse.component.html',
  styleUrls: ['./createorganasationcourse.component.scss']
})
export class CreateOrganasationCourseComponent implements OnInit {
  ...
  data: any = `<p>Hello, world!</p>`;
    ...
    constructor(private formBuilder: FormBuilder,
              ...
              private organasationService:OrganasationService) {
               this.route.data.subscribe(( data: { organasationtemplate: any }) => {
               this.schoolData = data.organasationtemplate.schoolData;
 ...
 setClassTypeData() {
  ...
  submit() {
    ...
    this.organasationService.createOrganasationCourse(organasationcourse).subscribe(response => {
